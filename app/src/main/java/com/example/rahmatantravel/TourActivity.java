...
public class TourActivity extends AppCompatActivity {
    ...
    private RecyclerView recyclePaketTour;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addDataPaket();
        recyclePaketTour = (RecyclerView) findViewById(R.id.recyclePaketTour);
        ...
        recyclePaketTour.setLayoutManager(layoutManager1);
        recyclePaketTour.setAdapter(paketAdapter);
    ...
    void addDataPaket(){
        ...
        try {
            ...
            paketModelsArrayList.add(new PaketModels("Paket Turki 21 Januari 2023", date1, 10, 5, 30000000));
            paketModelsArrayList.add(new PaketModels("Paket Palestina 10 Juni 2023", date2, 9, 5, 29000000));
            paketModelsArrayList.add(new PaketModels("Paket Yordania Turki 04 Januari 2023", date3, 4, 5, 5000000));
            paketModelsArrayList.add(new PaketModels("Paket Mesir 08 April 2023", date4, 12, 5, 28000000));

            PaketAdapter adapter = new PaketAdapter(paketModelsArrayList);
            recyclePaketTour.setAdapter(adapter);
