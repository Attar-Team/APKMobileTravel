...
class HajiActivity : AppCompatActivity() {

    private lateinit var recyclePaketHaji: RecyclerView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val customTypeFace = resources.getFont(R.font.poppinsmedium)
        ...
        val dialog = Dialog(this@HajiActivity)
        ...
        recyclePaketHaji = findViewById(R.id.recyclerView)
        imageView = findViewById(R.id.imageView)

        // Sembunyikan imageView di awal
        imageView.visibility = View.GONE

        RetrofitClient.instance.getPaketByMenu("Haji").enqueue(object : Callback<APIResponse> {
                ...
                if (response.isSuccessful){
                    ...
                    if (apiResponse != null) {
                        ...
                        if (data.isNullOrEmpty()) {
                            ...
                            recyclePaketHaji.visibility = View.GONE
                        } else {
                            // Jika data tidak kosong, tampilkan recyclerView dan sembunyikan imageView
                            imageView.visibility = View.GONE
                            recyclePaketHaji.visibility = View.VISIBLE
                            ...
                            adapter.onItemClick = { keberangkatanItem, paketItem, hotelItem ->
                                val intent = Intent(this@HajiActivity, DetailPaket::class.java)
                                intent.putExtra("keberangkatan_id", keberangkatanItem.id.toString())
                                intent.putExtra("paket_id", paketItem.id_paket.toString())
                                startActivity(intent)
                            }
                            val layoutManager1 = LinearLayoutManager(this@HajiActivity, LinearLayoutManager.VERTICAL, false)
                            recyclePaketHaji.layoutManager = layoutManager1
                            recyclePaketHaji.adapter = adapter
