...
class lunasPesanan : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_lunas_pesanan, container, false)
        ...
        RetrofitClient.instance.getPemesananByStatus("lunas", "1").enqueue(
